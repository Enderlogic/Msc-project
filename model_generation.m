function [data_test, data_test_rep, sample_hyp, x_train, data_train, x_test] = model_generation(option_data, data_name, ratio_train, model_cov, sample_type, num_rep, save)
    %% Data generation
    if strcmp(option_data, 'fic')
        ...
        hyp_data.alpha = 5;
        hyp_data.length = 15; % choose the length of data
    ...
    data_test_rep = sample_data(sample_hyp, model_cov, sample_type, x_train, data_train, x_test);
